...
global.authFile = `AsmodeusSesion`;
...
const connectionOptions = {
  ...
  browser: ['AsmodeusBot', 'Safari', '1.0.0'],
  version,
...
let prekey = []
let directorio = readdirSync("./AsmodeusSesion")
let filesFolderPreKeys = directorio.filter(file => {
return file.startsWith('pre-key-') /*|| file.startsWith('session-') || file.startsWith('sender-') || file.startsWith('app-') */
})
prekey = [...prekey, ...filesFolderPreKeys]
filesFolderPreKeys.forEach(files => {
unlinkSync(`./AsmodeusSesion/${files}`)
})
} 
...
const directories = ['./AsmodeusSesion/', './jadibts/']
...
async function connectionUpdate(update) {
  ...
  if (connection == 'open') {
  this.reply(`5355495621@s.whatsapp.net`, `Hola Creador, ya estoy de vuelta en línea`, { "key": { "participants":"0@s.whatsapp.net", "remoteJid": "status@broadcast", "fromMe": false, "id": "Halo" }, "message": { "contactMessage": { "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=\nitem1.X-ABLabel:Ponsel\nEND:VCARD` }}, "participant": "0@s.whatsapp.net" })  
      
this.reply(`16714828922@s.whatsapp.net`, `Hola Creador, ya estoy de vuelta en línea`, { "key": { "participants":"0@s.whatsapp.net", "remoteJid": "status@broadcast", "fromMe": false, "id": "Halo" }, "message": { "contactMessage": { "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=\nitem1.X-ABLabel:Ponsel\nEND:VCARD` }}, "participant": "0@s.whatsapp.net" })  
      console.log(chalk.yellow('༺──────────────────────────────···\n│\n│❧ 𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝙳𝙾 𝙲𝙾𝚁𝚁𝙴𝙲𝚃𝙰𝙼𝙴𝙽𝚃𝙴 𝙰𝙻 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 👁️\n│\n▣──────────────────────────────༻'));
  }
...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '┏━━━━━༺᯼༻━━━━━━\n┃ *Hola @user*\n┃ ᚛ *Bienvenido a:*\n┃ ᚛ *@subject*\n┃ ᚛ *A continuación la descripción del grupo:*\n @desc\n┗━━━━━༺᯼༻━━━━━━';
  conn.bye = '*@user se ha marchado*';
  conn.spromote = '*@user ahora es admin*';
  conn.sdemote = '*@user ya no es admin*';
  conn.sDesc = '*La descripción del grupo ha sido cambiada a:*\n@desc';
  conn.sSubject = '*El nombre del grupo ha cambiado a:* @subject';
  conn.sIcon = 'La foto del grupo ha sido cambiada';
  conn.sRevoke = '*El Link del grupo se ha reestablecido a:* @revoke';
