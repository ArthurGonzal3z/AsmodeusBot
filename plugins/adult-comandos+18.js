...
const handler = async (m, {command, conn}) => {
  if (!db.data.chats[m.chat].modohorny && m.isGroup) throw '*Los comandos para adultos están desactivados en este chat, si eres admin y deseas activarlos usa:  #enable modohorny*';
