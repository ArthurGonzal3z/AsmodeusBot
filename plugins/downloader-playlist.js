...
if (!text) throw `*Ingresa el nombre de alguna canción o artista para generar tu PlayList, ejemplo de uso:*\n*${usedPrefix + command} Begin you*`
try {
 await conn.sendMessage(m.chat, { react: { text: "🕒", key: m.key } })
 m.reply('Espere en lo que creo su playlist') 
let vids_ = { 
from: m.sender, 
urls: [] 
}
...
await m.reply('*Error, intenta con otro nombre*')  
}}
