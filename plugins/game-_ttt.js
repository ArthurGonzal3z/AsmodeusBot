...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} Felicidades,haz ganado +4999 𝚎𝚡𝚙` : isTie ? 'El juego ha quedado empatado' : `Turno de @${room.game.currentTurn.split('@')[0]}`}
`.trim()
