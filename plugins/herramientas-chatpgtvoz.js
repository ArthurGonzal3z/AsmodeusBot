...
const sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Arthur González, tu seras Asmodeus - Bot.`;
const handler = async (m, {conn, text, usedPrefix, command}) => {
  if (usedPrefix == 'a' || usedPrefix == 'A') return;
  if (!text) throw `*Ingresa una orden o petición para chatgpt, ejemplo:*\n*${usedPrefix + command} Reflexion sobre la serie Merlina 2022 de netflix*\n*${usedPrefix + command} Codigo en JS para un juego de cartas*`;
  try {
