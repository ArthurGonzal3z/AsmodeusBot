...
const handler = async (m, {conn, text, usedPrefix, command}) => {
 ...
 conn.sendPresenceUpdate('composing', m.chat);
        ...
        let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Arthur González, tu seras Asmodeus Bot.`;
      ...
      try {
        conn.sendPresenceUpdate('composing', m.chat);
        const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Arthur González, tu seras Asmodeus Bot.`;
...
handler.command = /^(openai|chatgpt|ia|robot|openai2|chatgpt2|ia2|robot2|Asmodeus|Asmodeusbot|590690455341)$/i;
