...
if (/^que es ntp|que es ntp?|que significa ntp|que significa ntp?$/i.test(m.text) && !chat.isBanned) { 
conn.sendPresenceUpdate('composing', m.chat)    
//conn.sendButton(m.chat, '', wm, [['𝙼𝙴𝙽𝚄 𝙳𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾𝚂', `#menu`]], 'conversation', { sendEphemeral: true, quoted: m })
await m.reply(`*Hola ${name} , NTP tiene como significado "No Te Preocupes", es solo una abreviación de la frase`)
