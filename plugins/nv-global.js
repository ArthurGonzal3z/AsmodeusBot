...
handler.all = async function(m, {conn}) {
  ...
  if ((m.mtype === 'groupInviteMessage' || m.text.startsWith('https://chat') || m.text.startsWith('Abre este enlace')) && !m.isBaileys && !m.isGroup && !chat.isBanned && !m.fromMe) {
    let join = `┏━━━━━༺᯼༻━━━━━━\n*Deseas añadir a Asmodeus a un grupo?*\n\n*⪧ Hola @${m.sender.split('@')[0]}, si deseas solicitar a Asmodeus Bot para tu grupo usa el comando #join mas el enlace de tu grupo.*\n\n*➛ Ejemplo:*\n*➛ #join* https://chat.whatsapp.com/J8ugOEnwmrCIKxPadExhhu\n\n*También puedes usar el comando:*\n#addbot\n*Para unir al bot temporalmente a tu grupo*\n┗━━━━━༺᯼༻━━━━━━`.trim();
    this.sendMessage(m.chat, {text: join.trim(), mentions: [...join.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), contextInfo: {forwardingScore: 9999999, isForwarded: true, mentionedJid: [...join.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), "externalAdReply": {"showAdAttribution": true, "containsAutoReply": true, "renderLargerThumbnail": true, "title": global.script, "containsAutoReply": true, "mediaType": 1, "thumbnail": global.imagen4, "mediaUrl": `http://wa.me/16714828922`, "sourceUrl": `http://wa.me/16714828922`}}}, {quoted: m});
  }
